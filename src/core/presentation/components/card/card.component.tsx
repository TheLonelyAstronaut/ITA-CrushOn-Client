        ...
        >
            <FullyPressable onPress={() => props.expandCard(props.user.id)}>
                <TextWrapper scale={props.scale}>
                    <WhiteText style={'bold'} scale={props.scale}>{props.user.name},{props.user.age}</WhiteText>
                    <LocationWrapper>
                        <LocationSVG color='white' size={14*props.scale} strokeWidth={props.scale}/>
                        <WhiteText style={'normal'} scale={props.scale} marginLeftSpacer={1}>{props.user.location} km away</WhiteText>
                    </LocationWrapper>
                </TextWrapper>
            </FullyPressable>
        </ImageBackgroundStyled>
